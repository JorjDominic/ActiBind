            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: const [
                  ...
                  SizedBox(height: 16),
                  Text('Focus Conflict Detected', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                  SizedBox(height: 8),
                  Text('Warning: You are using Instagram during your Work Block.', style: TextStyle(fontSize: 16)),
                ],
              ),
            ),
          ),
...
class _StatusCard extends StatelessWidget {
  const _StatusCard({required this.title, required this.value, required this.detail});
