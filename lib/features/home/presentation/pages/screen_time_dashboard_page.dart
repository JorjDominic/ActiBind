        ...
        children: [
          Container(
            ...
            child: Column(
              ...
              children: const [
                Text('Daily Insight', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                SizedBox(height: 12),
                Text('You’re 15% more focused than last Tuesday. Keep the momentum!', style: TextStyle(fontSize: 16)),
              ],
            ),
          ),
...
class _MetricCard extends StatelessWidget {
  const _MetricCard({required this.label, required this.value, required this.subtitle, this.showCircle = false, this.showBars = false, this.showProgress = false});
            ...
            Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: List.generate(7, (index) => _DayBar(index: index == 3 ? 1.0 : 0.6)),
                ),
                const SizedBox(height: 12),
                Text(subtitle),
              ],
